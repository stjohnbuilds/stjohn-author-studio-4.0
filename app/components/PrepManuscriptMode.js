...
// Only the warnings the user actually wants to see (orphan / missing /
  ...
  return (
    <div style={{ minHeight: '100vh', background: READER_PAGE_BG, paddingTop: usesCustomDragRegion ? 24 : 0 }}>
      ...
      {/* Top-left chrome: show the 4-mode pill only on the Prep home.
          Inside a project, swap it for a "← Home" button so the user has
...
// ===========================================================================
// Setup view — after import, before scanning. Let the user rename the
...
function SectionBody({ section, charactersById, selected, onSelectDialogue, dialogueRefs, onDialogueButtonMounted }) {
  ...
  // surface them as a small amber strip ABOVE the section text so the user
