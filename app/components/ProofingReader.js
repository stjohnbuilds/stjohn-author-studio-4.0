...
export default function ProofingReader({ section, audioUrl, narratorColors, manuscriptPaging = null, pdfPaging = null, includeChapterPreroll = true, defaultListeningSpeed = 2, onSaveFlags, onBack, canPrevChapter = false, canNextChapter = false, onPrevChapter, onNextChapter, sceneOptions = [], onJumpToScene = null, usesCustomDragRegion = false }) {
  ...
  function getAutoPageNumber(wordIdx, quoteText){
    ...
    // PDF. the user 2026-05-26 (later): book.pageNumberAdjustment lets the
    ...
    // No exact map available — flag it. the user's rule: never guess.
    return '?';
  }
