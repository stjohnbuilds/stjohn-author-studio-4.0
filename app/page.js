...
export default function Home() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--cream)' }}>
      ...
      />
      {view==='home'       && <HomePage books={books} isElectron={isElectron} dataLocation={dataLocation} onChangeDataLocation={handleChangeDataLocation} onNew={()=>setView('newBook')} onOpen={b=>{setActiveBook(b);setView('bookDetail');}} onImport={importBooks} onExport={exportBackup} onElectronImport={handleImport} />}
