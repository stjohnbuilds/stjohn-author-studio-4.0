...
log "Regular users should open Script and Sync Releases/StJohn Author Studio.app instead."
log ""
...
log "Close any already-open StJohn Author Studio windows before the build finishes replacing the app."
log "Building StJohn Author Studio for Mac — Terminal will stay open until this finishes (often several minutes)..."
...
log "Done. Your Mac app is in Script and Sync Releases/StJohn Author Studio.app."
log "Important: always open the rebuilt release copy there."
open "$ROOT/Script and Sync Releases/StJohn Author Studio.app" 2>/dev/null || true

osascript <<'APPLESCRIPT' 2>/dev/null || true
display dialog "Build finished." & return & return & "Open Script and Sync Releases/StJohn Author Studio.app." & return & return & "That is the app regular users should use." buttons {"OK"} default button "OK"
APPLESCRIPT
