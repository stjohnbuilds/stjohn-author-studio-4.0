...
- [ ] **Audiobook breakdown: still partial — needs the user's .docx to
      finish.** The harden-the-lookup pass above only helps when the
      chapter or section title contains the character name. the user's
      ...
      assign POV character per chapter. Decision needs the user + a look
