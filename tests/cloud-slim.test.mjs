    ...
    chapters: [
      {
        ...
        completed: true,
        audioPath: '/Users/example/audio/chapter-one.mp3',
        audioFileName: '/Users/example/audio/chapter-one.mp3',
        ...
        whisperAudioKey: 'path:/Users/example/audio/chapter-one.mp3',
