...
// the user 2026-05-26: "got this pink, this red, but it's not pink. I like
...
// the user 2026-06-06: matched to ManuscriptSetup.js DEFAULT_MANUAL_COLORS
...
// so it looks identical when the user clicks "+ Add character" anywhere.
        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, maxHeight: '60vh', overflowY: 'auto', paddingRight: 4 }}>
            {project.chapters.map((ch, i) => {
              ...
              // Crescent green, exactly as the user spec'd.
